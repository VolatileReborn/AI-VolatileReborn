from Algorithm.TrainingAlgo.ReportTrainingAlgo.DeepPrior.img_feature_extra.box import Bbox
...
class Component:
    ...
    def compo_get_boundary(self):
        #get the bounding boundary of component
    ...
    def compo_is_line(self, min_line_thickness):
        # check this object is line or not 
        slim = 0
